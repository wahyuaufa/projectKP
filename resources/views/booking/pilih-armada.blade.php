      ...
      <div class="col-md-6" data-aos="fade-up" data-aos-delay="{{ $idx * 100 }}">
        <label class="armada-card d-block" style="cursor:pointer;">
          ...
          <div class="armada-card-image">
            <svg viewBox="0 0 240 120" xmlns="http://www.w3.org/2000/svg" style="max-width:180px">
              ...
              <text x="120" y="65" text-anchor="middle" fill="#1A3A5C" font-size="10" font-weight="700">{{ $armada->nama }}</text>
            </svg>
          </div>
