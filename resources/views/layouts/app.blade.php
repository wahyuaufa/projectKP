...
<head>
  ...
  <title>@yield('title', 'PR GOTRAV Mitra Abadi')</title>
            ...
            @else
              ...
              <div class="dropdown">
                <button class="btn-outline-gotrav btn btn-sm d-flex align-items-center gap-2"
                  ...
                  {{-- Badge ADMIN kecil di samping nama --}}
                  @if(Auth::user()->isAdmin())
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0"
                    style="border-radius:var(--radius-sm);min-width:210px">

                  {{-- Info User --}}
                  <li>
                    <div style="padding:.7rem 1rem;border-bottom:1px solid var(--border)">
                      <div style="font-size:.82rem;font-weight:700;color:var(--text-dark)">
                  ...
                  {{-- Menu Admin — hanya muncul jika admin --}}
                  @if(Auth::user()->isAdmin())
                  <li>
                    <a class="dropdown-item d-flex align-items-center gap-2"
                       href="{{ route('admin.dashboard') }}"
                       style="font-size:.85rem;color:var(--accent);font-weight:600;padding:.5rem 1rem">
      ...
      <div class="row g-4">
        <div class="col-lg-4" data-aos="fade-up">
          ...
          <p style="font-size:.9rem;line-height:1.7;">
            Layanan travel door to door yang nyaman, aman, dan terpercaya. Kepuasan pelanggan adalah prioritas kami.
          </p>
          <div class="d-flex gap-2 mt-3">
            <a href="#" class="btn btn-sm"
               style="background:rgba(255,255,255,.1);color:#fff;border-radius:8px;width:36px;height:36px;display:flex;align-items:center;justify-content:center;">
